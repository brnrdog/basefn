...
let make = (
  ...
  let getClassName = () => {
    let variantClass = "eita-badge--" ++ variantToString(variant)
    let sizeClass = "eita-badge--" ++ sizeToString(size)
    let dotClass = dot ? " eita-badge--dot" : ""
