...
let make = (
  ...
  let getToastClass = () => {
    let variantClass = "eita-toast--" ++ variantToString(variant)
    "eita-toast " ++ variantClass
  }

  let getContainerClass = () => {
    let posClass = "eita-toast-container--" ++ positionToString(position)
    "eita-toast-container " ++ posClass
  }
      ...
      [
        <div class={getContainerClass()}>
          <div class={getToastClass()}>
            <div class="eita-toast__content">
              {switch title {
              | Some(titleText) =>
                <div class="eita-toast__title"> {Component.text(titleText)} </div>
              | None => <> </>
              }}
